...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    public class CreateConfigurationTemplateResult  
    {
        ...
        /// <returns>this instance</returns>
        public CreateConfigurationTemplateResult WithDateCreated(DateTime dateCreated)
        {
        ...
        /// <returns>this instance</returns>
        public CreateConfigurationTemplateResult WithDateUpdated(DateTime dateUpdated)
        {
        ...
        /// <returns>this instance</returns>
        public CreateConfigurationTemplateResult WithOptionSettings(params ConfigurationOptionSetting[] optionSettings)
        {
        ...
        /// <param name="optionSettings">The values to add to the OptionSettings collection </param>
        /// <returns>this instance</returns>
        public CreateConfigurationTemplateResult WithOptionSettings(IEnumerable<ConfigurationOptionSetting> optionSettings)
        {
            foreach (ConfigurationOptionSetting element in optionSettings)
            {
                this.optionSettings.Add(element);
