 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for SetTimeBasedAutoScaling operation
      /// </summary>
      internal class SetTimeBasedAutoScalingResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          SetTimeBasedAutoScalingResponse response = new SetTimeBasedAutoScalingResponse();
        ...
        private static SetTimeBasedAutoScalingResponseUnmarshaller instance;
        public static SetTimeBasedAutoScalingResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new SetTimeBasedAutoScalingResponseUnmarshaller();
          }
          return instance;
        }
