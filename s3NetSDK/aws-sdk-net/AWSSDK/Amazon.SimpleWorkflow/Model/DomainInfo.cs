...
{
    /// <summary>
    /// <para> Contains general information about a domain. </para>
    /// </summary>
    public class DomainInfo
    {
        ...
        /// <summary>
        /// The status of the domain: <ul> <li> <b>REGISTERED</b>: The domain is properly registered and available. You can use this domain for
        /// registering types and creating new workflow executions. </li> <li> <b>DEPRECATED</b>: The domain was deprecated using
