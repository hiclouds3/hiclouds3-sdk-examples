...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    internal class SourceDataTrimTitleUnmarshaller : IUnmarshaller<SourceDataTrimTitle, XmlUnmarshallerContext> 
    {
        public SourceDataTrimTitle Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        sourceDataTrimTitle.SourceName = StringUnmarshaller.GetInstance().Unmarshall(context);
                            
                        continue;
                    } 
                    if (context.TestExpression("DefaultValue", targetDepth))
                    {
                        sourceDataTrimTitle.DefaultValue = StringUnmarshaller.GetInstance().Unmarshall(context);
                            
                        continue;
                    } 
                    if (context.TestExpression("Separator", targetDepth))
                    {
                        sourceDataTrimTitle.Separator = StringUnmarshaller.GetInstance().Unmarshall(context);
                            
                        continue;
                    } 
                    if (context.TestExpression("Language", targetDepth))
                    {
                        sourceDataTrimTitle.Language = StringUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public static SourceDataTrimTitleUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new SourceDataTrimTitleUnmarshaller();
