...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    internal class IndexDocumentsResultUnmarshaller : IUnmarshaller<IndexDocumentsResult, XmlUnmarshallerContext> 
    {
        public IndexDocumentsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        indexDocumentsResult.FieldNames.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
        ...
        public static IndexDocumentsResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new IndexDocumentsResultUnmarshaller();
