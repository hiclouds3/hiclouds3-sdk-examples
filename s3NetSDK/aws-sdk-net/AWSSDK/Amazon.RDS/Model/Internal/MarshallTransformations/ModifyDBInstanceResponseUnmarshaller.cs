...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ModifyDBInstanceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.ModifyDBInstanceResult = ModifyDBInstanceResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static ModifyDBInstanceResponseUnmarshaller instance;

        public static ModifyDBInstanceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ModifyDBInstanceResponseUnmarshaller();
            }
            return instance;
        }
