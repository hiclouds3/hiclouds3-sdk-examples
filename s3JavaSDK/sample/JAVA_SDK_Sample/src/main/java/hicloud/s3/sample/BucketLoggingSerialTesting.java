...
public class BucketLoggingSerialTesting {
  ...
  private static void basicPutBucketandACL(String bucketName, String bucketName2)
      throws IOException {
  ...
  private static void basicPutBucketLogging(String bucketName, String bucketName2)
      throws IOException {
    AmazonS3 s3 = S3Client.getClient();
    ...
    try {
      ...
      SetBucketLoggingConfigurationRequest request =
          new SetBucketLoggingConfigurationRequest(bucketName, config);
  ...
  private static void basicDisableBucketLogging(String bucketName, String bucketName2)
      throws IOException {
    AmazonS3 s3 = S3Client.getClient();
  ...
  public static void main(String args[]) throws IOException {
    ...
    /*
     * test 1. PutBucketLogging 2. GetBucketLogging
     */
    basicPutBucketLogging(args[0], args[1]);

    /*
     * test 1. DisableBucketLogging 2. GetBucketLogging
     */
