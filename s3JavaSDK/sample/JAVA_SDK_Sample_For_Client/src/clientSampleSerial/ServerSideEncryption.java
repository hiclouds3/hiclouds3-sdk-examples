...
public class ServerSideEncryption {
  ...
  private static void SSEPutObject(String bucketName, String objectName, String filePath)
      throws IOException {
  ...
  private static void SSEGetObject(String bucketName, String objectName, String filePath)
      throws IOException {
    ...
    try {
      ...
      System.out
          .println("ServerSideEncryption: " + object.getObjectMetadata().getServerSideEncryption());
