...
public class PreSignedURL{
	...
	{
    	Constants.S3_HOSTNAME= "s3.hicloud.net.tw";
    	AmazonS3 s3 = new AmazonS3Client(new PropertiesCredentials(PreSignedURL.class.getResourceAsStream("AwsCredentials.properties")));
    	...
    	try
		{
    		...
    		GeneratePresignedUrlRequest request = new GeneratePresignedUrlRequest(args[0], args[2], HttpMethod.PUT);
