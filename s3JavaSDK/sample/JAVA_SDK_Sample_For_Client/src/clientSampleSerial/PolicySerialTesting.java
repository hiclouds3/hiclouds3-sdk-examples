...
public class PolicySerialTesting {
  ...
  private static void basicPutBucketPolicy(String bucketName) throws IOException {
    ...
    // Prepare Policy
    String policy =
        "{\"Version\": \"2008-10-17\",\"Id\": \"Policy1355909850780\",\"Statement\": [{\"Sid\": \"Stmt1355909849219\",\"Effect\": \"Allow\",\"Principal\": {\"AWS\": \"*\"},\"Action\": \"s3:GetObject\",\"Resource\": \"arn:aws:s3:::"
            + bucketName + "/*" + "\"}]}";
  ...
  public static void main(String args[]) throws IOException {
    ...
    /*
     * test 1. PutBucketPolicy 2. GetBucketPolicy 3. DeleteBucketPolicy
     */
