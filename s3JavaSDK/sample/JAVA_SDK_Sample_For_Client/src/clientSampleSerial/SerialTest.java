...
public class SerialTest {
    ...
    private static void expectException(int expect, AmazonServiceException ase) {
        if (expect != ase.getStatusCode()) {
            System.out.println("Caught an AmazonServiceException, which means your request made it "
                    + "to Amazon S3, but was rejected with an error response for some reason.(Expect:" + expect
                    + ",but get" + ase.getStatusCode() + ")");
    ...
    private static void teardownPro(String bucketName) throws IOException {
        ...
        AmazonS3 s3 =
                new AmazonS3Client(new PropertiesCredentials(
                        VersioningSerialTesting.class.getResourceAsStream("AwsCredentials.properties")));
    ...
    public static void main(String args[]) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        String bucketName1 = "bucketone";
        String bucketName2 = "buckettwo";
        String objectName1 = "objectone";
        String objectName2 = "objecttwo";
        String objectName3 = "objectthree";
        String oriFilePath = (SerialTest.class.getResource("5M_File.jpg").getFile()).replaceAll("%20", " ");
        String newFilePath = (SerialTest.class.getResource("/").getFile() + "new_File.jpg").replaceAll("%20", " ");
        String sbucketName = "source";
        String dbucketName = "target";
        

        String args1[] = {bucketName1, bucketName2, objectName1, objectName2, objectName3, oriFilePath, newFilePath};
