...
public class UploadBigFileByMPU {
  ...
  private static void autoUploadBigFileByPart(String bucketName, String fileName, String filePath)
      throws IOException {
    ...
    try {
      ...
      // 甇斤��內蝭���蝙�����之瑼炬��MPU銝�hicloud S3
      // 甇斤��銵��之瑼瘥art�5MB��art瑼蒂��銝�hicloud
      // S3嚗�敺蝙�CompleteMPU撠art瑼�����之瑼�
      // 甈脰銵�part瑼蒂��銝�hicloud S3嚗���PUSerial.java
      System.out.println("basic initial MPU");
      InitiateMultipartUploadResult initResponse = s3.initiateMultipartUpload(initRequest);
      String UploadID = initResponse.getUploadId();

      // ����憭扳�Part瑼蒂雿輻UploadPart銝�hicloud S3
      ...
      for (int i = 1; filePosition < contentLength; i++) {
        ...
        UploadPartRequest uploadRequest = new UploadPartRequest().withBucketName(bucketName)
            .withKey(fileName).withUploadId(UploadID).withPartNumber(i).withFileOffset(filePosition)
