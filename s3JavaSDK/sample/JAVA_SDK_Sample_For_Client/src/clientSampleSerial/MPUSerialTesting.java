...
public class MPUSerialTesting{
	...
	private static void basicUploadPart(String bucketName, String fileName, String uploadID ,int partNumber, String filePath) throws IOException
	{
		...
		AmazonS3 s3 = new AmazonS3Client(new PropertiesCredentials(MPUSerialTesting.class.getResourceAsStream("AwsCredentials.properties")));
		try
		{	
			//UploadPart
	...
	private static void AbortMPU(String bucketName, String fileName, String filePath) throws IOException
	{
	...
	private static void CompleteMPU(String bucketName, String fileName, String filePath) throws IOException
	{
		ObjectMetadata meta = new ObjectMetadata();
	...
	private static void CopyPart(String bucketName, String sbucketName, String fileName, String sfileName, String filePath) throws IOException
	{
		...
		try
		{
            ...
            PutObjectResult object = s3.putObject(new PutObjectRequest(sbucketName, sfileName, createSampleFile(filePath)).withFile(createSampleFile(filePath)).withMetadata(metadata));
	...
	private static void PrefixListMPUs(String bucketName, String Prefix, String Delimiter) throws IOException //Prefix & Delimeter
	{
	...
	private static void MaxListMPUs(String bucketName, String KeyMarker, int MaxUpload) throws IOException //MaxUpload & KeyMarker
	{
	...
	private static void MarkerListMPUs(String bucketName, String IDMarker) throws IOException //Upload ID Marker
	{
