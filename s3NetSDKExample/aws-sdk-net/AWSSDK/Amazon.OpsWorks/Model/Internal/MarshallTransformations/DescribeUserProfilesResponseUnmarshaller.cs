 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for DescribeUserProfiles operation
      /// </summary>
      internal class DescribeUserProfilesResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static DescribeUserProfilesResponseUnmarshaller instance;
        public static DescribeUserProfilesResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeUserProfilesResponseUnmarshaller();
          }
          return instance;
        }
