 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for ListJobsByStatus operation
      /// </summary>
      internal class ListJobsByStatusResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static ListJobsByStatusResponseUnmarshaller instance;
        public static ListJobsByStatusResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new ListJobsByStatusResponseUnmarshaller();
          }
          return instance;
        }
