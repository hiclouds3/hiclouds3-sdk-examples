...
namespace Amazon.RDS
{
    ...
    /// or on the next instance reboot or during the maintenance window. To get started with Amazon RDS, go to the Amazon RDS Getting Started Guide.
    /// For more information on Amazon RDS concepts and usage scenarios, go to the Amazon RDS User Guide. </para>
    /// </summary>
