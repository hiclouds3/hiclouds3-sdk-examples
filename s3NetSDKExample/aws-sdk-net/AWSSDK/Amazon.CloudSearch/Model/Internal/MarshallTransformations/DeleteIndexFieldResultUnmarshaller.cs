...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    internal class DeleteIndexFieldResultUnmarshaller : IUnmarshaller<DeleteIndexFieldResult, XmlUnmarshallerContext> 
    {
        public DeleteIndexFieldResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        deleteIndexFieldResult.IndexField = IndexFieldStatusUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public static DeleteIndexFieldResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new DeleteIndexFieldResultUnmarshaller();
