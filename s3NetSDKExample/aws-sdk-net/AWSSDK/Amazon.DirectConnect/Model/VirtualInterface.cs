...
namespace Amazon.DirectConnect.Model
{
    ...
    public class VirtualInterface  
    {
        ...
        /// <returns>this instance</returns>
        public VirtualInterface WithVlan(int vlan)
        {
            this.vlan = vlan;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        public VirtualInterface WithAsn(int asn)
        {
            this.asn = asn;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        public VirtualInterface WithRouteFilterPrefixes(params RouteFilterPrefix[] routeFilterPrefixes)
        {
        ...
        /// <param name="routeFilterPrefixes">The values to add to the RouteFilterPrefixes collection </param>
        /// <returns>this instance</returns>
        public VirtualInterface WithRouteFilterPrefixes(IEnumerable<RouteFilterPrefix> routeFilterPrefixes)
        {
            foreach (RouteFilterPrefix element in routeFilterPrefixes)
            {
                this.routeFilterPrefixes.Add(element);
