...
namespace Amazon.Redshift.Model
{
    ...
    public class DescribeClusterParametersResult
    {
        ...
        /// <summary>
        /// A marker that indicates the first parameter group that a subsequent <a>DescribeClusterParameterGroups</a> request will return. The response
        /// returns a marker only if there are more parameter groups details to list than the current response can return.
        ///  
        /// </summary>
