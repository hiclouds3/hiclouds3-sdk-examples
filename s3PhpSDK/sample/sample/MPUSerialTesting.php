...
function ListMPU(){
	...
	$datetime = new DateTime('17 Oct 2019');
	...
	$acp->addGrantForUser('FULL_CONTROL', $userBCanonicalId);
	...
	//Copy時帶有Range header，來源端檔案Size需大於5GB
	//Range header指定的range需大於5MB
	//		'CopySourceRange' => 'bytes=50-5542880', Optional: Copy Range
			'UploadId'=> $uploadID2
	));
